<?php
	...
	$conf["vars"]["tplName"] = "Setup and Wizard";
	...
	$conf["vars"]["dir"][] = array("name"=>"controllers","optional" => true);
	$conf["vars"]["dir"][] = array("name"=>"flags","optional" => true);
	$conf["vars"]["dir"][] = array("name"=>"monitors","optional" => true);
