<?php
	...
	$config["mista"]["params"][] = "/var/www/names.txt";

	//$config["intro"]["type"] = "package";
	//$config["intro"]["name"] = "config";

	$config["miste"]["type"] = "module";
	$config["miste"]["name"] = "TesDriv";
	$config["miste"]["action"] = "getFileByHelper";
	$config["miste"]["params"] = 4344;
	$config["miste"]["path"] = "app";
	return $config;
?>
