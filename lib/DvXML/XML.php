...
class XML {
     ...
     * @return Array
     */
	public static function toJson ($xmlS){		
		$xml = simplexml_load_string($xmlS);		
        return json_encode(array($xml->getName()=>$xml));
	}
	
    public static function toArray($xmlS) {		
        $json = self::toJson($xmlS);
